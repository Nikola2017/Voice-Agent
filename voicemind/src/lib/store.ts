...
import type { AppState, Note, EnrichmentMode, RecordingState, Language, User, AuditLogEntry, Team, RecordingSettings } from '@/types';
...
export const useAppStore = create<ExtendedAppState>()(
  persist(
    (set, get) => ({
      ...
      setRecordingSettings: (settings: Partial<RecordingSettings>) => set((state) => ({
